...
<h3>H2 Server Console</h3>
<p>The H2 console is available at <a href="http://localhost:8082/">http://localhost:8082/</a>.</p>
<p>Use the following settings to connect to the local prod database (both username and password is "sa").</p>
<p><img src="resources/img/screenshots/h2login.png"/></p>
<p>After clicking connect you should be presented with the following view.</p>
<p><img src="resources/img/screenshots/h2console.jpg"/></p>
</div>
</div>
...
<p>A good practice is to add a separate change set in the end of the file which tags the database:</p>
<pre class="prettyprint linenums">
&lt;changeSet author=&quot;joel&quot; id=&quot;PET001:3&quot;&gt;
  &lt;tagDatabase tag=&quot;excercise1&quot;/&gt;
&lt;/changeSet&gt;
</pre>
If we ever need to re-run the changeset on an empty database we don't have to manually add the tags at the appropriate points.
...
<div class="row">
<div class="span9">
<p><span class="label label-info">3.1</span> Use the <code>generateChangeLog</code> with appropriate parameters to generate the data changelog.</p>
...
<p><span class="label label-info">3.4</span> Update liquibas.properties and set the <code>contexts</code> option to <code>default,test</code>.</p>
<p><span class="label label-warning">Note</span> Be careful not to run liquibase on the prod database with the test context active!</p>
...
<p>See <a href="http://www.liquibase.org/manual/rename_column">http://www.liquibase.org/manual/rename_column</a>.</p>
...
<p>See <a href="http://www.liquibase.org/manual/add_primary_key_constraint">http://www.liquibase.org/manual/add_primary_key_constraint</a>.</p>
...
<p>See <a href="http://www.liquibase.org/manual/add_foreign_key_constraint">http://www.liquibase.org/manual/add_foreign_key_constraint</a>.</p>
...
<p>See <a href="http://www.liquibase.org/manual/create_table">http://www.liquibase.org/manual/create_table</a>.</p>
...
<p>See <a href="http://www.liquibase.org/manual/insert_data">http://www.liquibase.org/manual/insert_data</a>.</p>
<p>See <a href="http://www.liquibase.org/manual/custom_sql">http://www.liquibase.org/manual/custom_sql</a>.</p>
...
<p>See <a href="http://www.liquibase.org/manual/add_lookup_table">http://www.liquibase.org/manual/add_lookup_table</a>.</p>
...
<p>See <a href="http://www.liquibase.org/manual/create_view">http://www.liquibase.org/manual/create_view</a>.</p>
...
<p>See <a href="http://www.liquibase.org/manual/add_column">http://www.liquibase.org/manual/add_column</a>.</p>
<p>See <a href="http://www.liquibase.org/manual/column">http://www.liquibase.org/manual/column</a>.</p>
...
<p><span class="label label-warning">Note</span> Be careful not to run liquibase on the prod database with the test context active! </p> <p>Edit liquibase.properties and remove the test context from the contexts option before running liquibase update.</p>
